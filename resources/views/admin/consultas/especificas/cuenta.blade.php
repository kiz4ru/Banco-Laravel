            ...
            <div class="col-md-12 mt-5">
                <div class="card align-items-center">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">🪪 DNI Cliente: {{ $cuenta->cliente->dni }}</li>
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">DNI Dueño Cuenta</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($transferencias as $transferencia)
                                    <tr>
                                        ...
                                        <td>{{ $transferencia->cuentaDestino->cliente->dni }}</td>
                                        <td>{{ $transferencia->cantidad }}&euro;</td>
                                        <td>{{ $transferencia->created_at }}</td>
                                    </tr>
                                    @break($loop->iteration > 2) {{-- Solo mostrar las 3 últimas transferencias --}}
                                @endforeach
                            </tbody>
                        </table>
                    </div>
